...
<section class="content">
    <div class="card">
        <div class="card-header">
            <h3 class="card-titl">Tambah Jabatan</h3>
        </div>
        <div class="card-body">
            <form method="POST">
                ...
                <div class="form-group">
                    <label for="nama_lokasi">Gaji Pokok</label>
                ...
                <div class="form-group">
                    <label for="nama_lokasi">Tunjangan</label>
                    <input type="number" class="form-control" name="tunjangan_jabatan"
                    onkeypress = 'return (event.charCode > 47 && event.charCode < 58) || event.charCode == 46'
                    >
                </div>
                <div class="form-group">
                    <label for="nama_lokasi">Uang Makan Perhari</label>
